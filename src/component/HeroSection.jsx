...
const HeroSection = () => {
  ...
  return (
    <div>
       <div className="flex text-black w-[97%]  overflow-hidden p-2.5 ">
        <div className="bg-white wrounded-l-2xl w-2/3 ml-[0.6rem]">
          <nav className="flex justify-left">
            ...
            <ul className="flex gap-x-[2rem] text-right mt-2.5 mr-4.5 mb-0 ml-0 no-underline pt-0.5 pb-0.5 pr-16 pl-[4rem]">
              <li>
                <a href='/map' className="text-#181414 font-bold">Home</a>
              </li>
              <li>
                <a href='/' className="text-#181414 font-bold">Vilas</a>
              </li>
              <li>
                <a href='/test' className="text-#181414 font-bold">Manor</a>
              </li>
              <li className='flex '>
          ...
          <div className='flex -mt-9 -mb-[3rem] mx-0.5 gap-5 items-center sm:'>
            ...
            <img src="https://1.bp.blogspot.com/-TlIRtOXmmDA/WS8Ar-jMLDI/AAAAAAAAH58/b03hdJmdDTs6j0X9d9FQOlHWAHYTJC6KQCK4B/s1600/Stock%2Bimages%2Bare%2Boften%2Bcasted%2Bwith%2Battractive%2Bpeople%2B...-790465.jpg" alt="" className=" w-[9rem] h-[8.6rem] object-cover   rounded-full my-[10px] mx-[-74px] sm:mx-[-14px] border-yellow-400" />
